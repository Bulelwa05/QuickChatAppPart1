...
public class TestingQuickChatApp1 {
    ...
    public void testIncorrectPassword() {
        Registration reg = new Registration("kyle!!!!!!!", "Passw0rd!", "088966553");
    ...
    public void testIncorrectPhoneNumber() {
        Registration reg = new Registration("kyle!!!!!!!", "Passw0rd!", "08966553");
        assertEquals("Cell phone number incorrectly formatted or does not contain international code.", reg.validatePhoneNumber());
    }
